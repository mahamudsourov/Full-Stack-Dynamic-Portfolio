...
<body>
  ...
  <section id="Skills" class="section">
    ...
    <div class="cards-container">
      <div class="card skill-card"><h3>Web Development</h3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora, delectus?</p></div>
    <div class="card skill-card"><h3>Python | C++ | C</h3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, in.</p></div>
      <div class="card skill-card"><h3>ML & DL</h3><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, blanditiis!</p></div>
      <div class="card skill-card"><h3>Artificial Intelligence</h3><p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti, consequuntur?</p></div>
    </div>
  </section>
  ...
  <div class="cards-container portfolio-grid">
    <div class="card">
      ...
      <div class="github-btn-wrapper">
        <a href="https://github.com/yourusername/lost-found-app" class="github-btn" target="_blank">View on GitHub</a>
      </div>
    </div>
    <div class="card">
      <img src="assets/images/nft.webp" alt="Sourov">
